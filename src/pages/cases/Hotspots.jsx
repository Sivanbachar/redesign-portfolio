      ...
      <div className="cs-body">
        ...
        <div className="cs-section">
          ...
          <div className="cs-decision-grid sr" style={{ marginTop: 40 }}>
            {[
              ['01 — Toggle on', 'Reader activates Hotspots via the toggle pill in the reading corner. The surface shifts — inline markers appear on 2–4 entities per screen.'],
