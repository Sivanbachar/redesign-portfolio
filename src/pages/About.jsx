      ...
      <div className="resume-wrap">
        ...
        <div className="resume-header sr">
          <div className="resume-photo-wrap">
            <img src="/portrait.jpg" alt="Sivan Baum" className="resume-portrait" />
          </div>
          <div>
            ...
            <p className="resume-bio">
              Senior Product Designer at Amazon, focused on the Kindle reading experience. I work
              at the intersection of product strategy and interaction design — defining what to
              build, not just how it looks. I've shipped features used across millions of reading
              sessions and built the frameworks that let teams move faster.
            </p>
          ...
          <div className="resume-left">
            ...
            <div className="sr">
              ...
              <div className="edu-entry">
                ...
                <p className="edu-year">2012 — 2016</p>
              </div>
              <div className="edu-entry">
