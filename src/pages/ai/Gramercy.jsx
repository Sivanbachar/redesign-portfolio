...
const p = AI_PROJECTS.find(x => x.id === 'gramercy')

export default function AIGramercy() {
  useScrollReveal()
      ...
      <div className="aip-body">
        ...
        <section className="aip-section sr">
          <div className="aip-section-label">
            <span className="cs-section-label">Live Site</span>
          </div>
            ...
            >
              <div className="aip-proto-cta-inner">
                <div className="aip-proto-cta-left">
                  <p className="aip-proto-cta-label">Production Website</p>
                  <p className="aip-proto-cta-name">{p.liveUrl.replace('https://', '')}</p>
                  <p className="aip-proto-cta-sub">Hosted on Netlify · Opens in new tab</p>
                </div>
                <span className="aip-proto-cta-btn">Visit Site ↗</span>
              </div>
            </a>
          </div>
        </section>
